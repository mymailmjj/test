...
public class QueryTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		path = FileSystems.getDefault().getPath("C://Users//AZ6367//Desktop//0000//index");
	...
	public void testTermQuery() {
		...
		Query termQuery = new TermQuery(new Term("contents", "potential"));
	...
	public void testPrefixQuery() {
		...
		Query prefixQuery = new PrefixQuery(new Term("contents", "acc"));
